...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">登录gek系统</p>
        <c:if test="${param.error != null}">
            <p>您的账号或者密码有误，请重新登录~</p>
        </c:if>
        ...
        <form action="/login/check" method="post">
            <div class="form-group has-feedback">
                <input id="account" type="text" class="form-control" autofocus placeholder="账号/邮箱" name="username">
